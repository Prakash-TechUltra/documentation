...
- :guilabel:`Benefit Field`: select from the drop-down menu the corresponding type of field in the
  contract for this benefit.
- :guilabel:`Cost Field`: select from the drop-down menu the type of cost incurred by the compnay
...
- :guilabel:`Related Type`: select from the drop-down menu what type of benefit it is. Select from
  ...
  field is required.
- :guilabel:`Benefit Field`: select from the drop-down menu the field on the contract the benefit
  appears.
